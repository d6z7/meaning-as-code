...
scope: GENERIC methodology — domain-independent and vendor-neutral. Contains NO reference to any
  specific business domain, warehouse, or vendor. Any project (GAPS included) is ONE application of
...
companions:
  ...
  - mac.schema.json     # v0.1.6: the machine-checkable schema — the strict, enforceable contract
  - CONFORMANCE.md      # v0.1.6: conformance levels + the closed-core / `x-` extension rule
