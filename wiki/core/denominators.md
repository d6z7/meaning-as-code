...
|---|---|
| topic | `denominators` |
| audience | `wiki/core/` — entries declare 3 different tracks (core 15, ontology 1, platform 3) — a topic both audiences touch is shared law |
| entries compiled | 19 |
| source_hash | `3197dc9239622cb4…` (sha256 over each entry's id and bytes) |
