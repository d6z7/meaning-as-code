...
| entries compiled | 18 |
| normative spans | 8 marked over 5 of 18 entry(ies) — 5 rule, 3 boundary |
| source_hash | `3106e4d210358555…` (sha256 over each entry's id and bytes, and over the claims marked on them) |
...
**RULE** · `2026-09-12/019-the-detector-probes-leaked-into-the-method-doc` · from *WHAT CHANGED* · UNRATIFIED
...
**BOUNDARY** · `2026-09-13/056-the-gate-was-a-catalogue-of-what-it-forbids` · from *WHAT IT DOES NOT PROVE* · UNRATIFIED
...
18 entry(ies), in time order: 11 defect, 5 build, 1 decision, 1 measurement.
...
[[cite: protocol/2026-09-13/051-the-consoles-mount-state-is-not-repository-state.md:13-15]]
...
[[cite: protocol/2026-09-13/051-the-consoles-mount-state-is-not-repository-state.md:19-26]]
...
[[cite: protocol/2026-09-13/051-the-consoles-mount-state-is-not-repository-state.md:30-30]]
...
[[cite: protocol/2026-09-13/051-the-consoles-mount-state-is-not-repository-state.md:34-38]]
