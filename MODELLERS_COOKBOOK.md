...
> honesty). This is a known gap, not an oversight. *(Applied note for the GAPS project: see its internal
> BACKLOG "Data-curation layer" item — but that belongs to the application, not this framework.)*
