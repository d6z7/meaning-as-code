...
# intended outputs may move) and the applied-instance test (point it at an applied ontology, e.g. FPL).
#
...
# mmdc drives a headless browser via puppeteer; auto-discover a LOCAL chrome-headless-shell so FPL/example
