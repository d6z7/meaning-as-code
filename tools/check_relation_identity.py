...
schema already separates serving from raw). A divergence — e.g. stem `v_<source>_serving_kpi` vs
table.name `v_<source>_serving_kpi_clean` — is the cross-reference break this gate reds on.
